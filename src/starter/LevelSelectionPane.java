...
public class LevelSelectionPane extends GraphicsPane {
	...
	private static final String IMAGES[]= {"example_back.jpg","portMapMain.png","menu_back_arrow.png","highlight.png"};
	private GImage arena1,arena2,backArrow,highlight;
	...
	public void checkChoice()
	{
		...
		{
		case 1:
			program.gamePane.set_Choice(LEVEL_DANIEL);
			program.switchToCharacterPane();
			break;
		case 2:
			program.gamePane.set_Choice(LEVEL_MIGUEL);
			program.switchToCharacterPane();
			break;
		case 3:
			program.switchToCharacterPane();
